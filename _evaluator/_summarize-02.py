			...
			for ith in range(len(_info_base)):
				if ith <= (len(_info_improved) - 1) and _info_base[ith]['word'] == _info_improved[ith]['word']: # compute only if imprved and base elements point to same word
					...
					if _info_base[ith]['font_size'] != _info_improved[ith]['font_size']:
						...
						if _info_improved[ith]['font_size'] < 24 or _info_improved[ith]['font_size'] > 44:
							tmp['font_size'] = -1

						if _info_improved[ith]['font_size'] < _info_base[ith]['font_size']:
							tmp['font_size'] = -1
					...
					if _info_base[ith]['font_color'] != _info_improved[ith]['font_color']:
						...
						try:
							...
							print(_base_bg[slide]['background'], '--', _improved_bg[slide]['background'])
							if int(str(_base_bg[slide]['background']), 16) and int(str(_improved_bg[slide]['background']), 16):
								...
								print('base::', base_font_contrast, 'vs', base_bg_contrast, '->', base_contrast_value)
								...
								print('improved::', improved_font_contrast, 'vs', improved_bg_contrast, '->', improved_contrast_value)
								...
								if (base_contrast_value - improved_contrast_value) >= 30:
									print('contrast-to-non::', base_contrast_value, 'vs', improved_contrast_value, '<br>')
									print('contrast-lvl::', base_contrast_value, '-', improved_contrast_value, (base_contrast_value - improved_contrast_value), '<br>')
									tmp['font_color'] = -1
								#elif _info_base[ith]['font_color'] != 'FFFFFF' and _info_improved[ith]['font_color'] in ['FFFFFF', '000000']:
								#elif _info_base[ith]['font_color'] != 'FFFFFF' and _info_improved[ith]['font_color'] in ['000000']:
					...
					tmp['improved_percentage'] = (_sum_improved / 2) # float("{0:.2f}".format(_sum_improved / 2))
