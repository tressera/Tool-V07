...
//Global variables for using every place
const PRIMARY = '238, 13, 13';
const SUCCESS = '149, 204, 71';
const INFO = '64, 196, 255';
const WARNING = '252, 179, 34';
const DANGER = '240, 80, 80';
const LIGHT = '176, 190, 197';
const DARK = '17, 17, 17';
...
(function($) {
    ...
    $('.window_fullscreen-x').on('click', function() {
...
(function($) {
    ...
    toastr.success("Drora is Restaurant Admin Dashboard HTML Template", "Welcome to Drora", {
        timeOut: 5000,
        closeButton: !0,
        debug: !1,
        newestOnTop: !0,
