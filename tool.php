            ...
            <div class="container-fluid">
                ...
                <div class="col-xl-6 col-xxl-12 pads-4-left-right-2-top-bottom">
                    <div class="card">
                        ...
                        <h5 class="text-center font-g">Upload your BASE and MODIFIED powerpoint presentation files below.</h5>
                        ...
                        <div class="card-body pads-top-bottom-5">
                            <form action="upload.php" method="post" enctype="multipart/form-data" muliple>
                                <div class="row">
                                    <div class="col-lg-6 mb-4 pads-4-left-right-2-top-bottom">
                                        <p class="text-center">Upload your BASE powerpoint file here:</p>
                                        <input type="file" class="dropify" name="targetFile[]" required="" />
                                    </div>
                                    <div class="col-lg-6 mb-4 pads-4-left-right-2-top-bottom">
                                        <p class="text-center">Upload your MODIFIED powerpoint file here:</p>
                                        <input type="file" class="dropify" name="targetFile[]" required="" />
                                    </div>
                                </div>
