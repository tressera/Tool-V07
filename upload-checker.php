<?php
	...
	// if everything is ok, try to upload file
		...
		$output_unpack = shell_exec("/mnt/NARRA/_dev/others/Tool-V07/venv/bin/python ./_evaluator/main.py --unpack \"".$base_filename."\" --texts --colors --images");
		...
		if (strpos($output_unpack, 'DONE') > 0) {
			...
			$output_summarize = shell_exec("/mnt/NARRA/_dev/others/Tool-V07/venv/bin/python ./_evaluator/main.py --check \"".$base_filename."\"");
